      ...
      <div class="container">
        ...
        <div class="form-group row col-lg-4 col-lg-offset-2">
          ...
          <div class="form-group row col-lg-4 col-lg-offset-2">
            ...
            <div class="col-sm-2">
              <input type="text" maxlength="3" class="form-control" id="latitude" name="latitude" placeholder="Latitude" onkeypress="return isNumber(event)">
            </div>
          </div>
          ...
          <div class="form-group row col-lg-4 col-lg-offset-2">
            ...
            <div class="col-sm-2">
              <input type="text" maxlength="3" class="form-control" id="longitude" name="longitude" placeholder="Longitude" onkeypress="return isNumber(event)">
            </div>
          </div>
